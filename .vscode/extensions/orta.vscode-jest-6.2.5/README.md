...
![image](https://github.com/jest-community/vscode-jest/raw/HEAD/images/v6-quick-start.png)
...
## Releases 
- **Current** ([v6.2.5](https://github.com/jest-community/vscode-jest/releases/tag/v6.2.5)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v6.md#v625)
- **Previous** ([v5.2.3](https://github.com/jest-community/vscode-jest/releases/tag/v5.2.3)): [release note](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v5.x.md#v523)

 
All: [Release Notes](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-notes.md)
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/interface-6.1.0.png" alt="interface-6.1.0.png" width="1000"/>
...
For more details see the [setup tool](https://github.com/jest-community/vscode-jest/blob/HEAD/setup-wizard.md) and the complete customization options in [settings](#settings).
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/runmode-chooser.png" alt="runMode Chooser Interface" width="800"/>
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/run-test.png" alt="run-test" width="800"/>
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/run-debug.png" alt="run-debug" width="800"/>
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/coverage-screen-shot.png" alt="coverage-screen-shot" width="500"/>
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/snapshot-menu.png" alt="snapshot-menu" width="800"/>
...
For option 1 and 2, the easiest way to setup the monorepo projects is to use the [Setup Tool](https://github.com/jest-community/vscode-jest/blob/HEAD/setup-wizard.md#setup-monorepo-project) and choose **Setup monorepo project**. 
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/status-bar-overview.png" alt="snapshot-menu" width="500"/>
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/quick-fix-chooser.png" alt="coverage-screen-shot" width="800"/>
...
2. A quick-fix chooser listed the fixes and hints to help resolve common errors:
   - **Customize Extensions**: If you can run jest with CLI in the terminal but not with the extension, chances are you might need to configure the `jest.jestCommandLine`, `jest.rootPath`, monorepo settings, etc. This action will open the [setup tools](https://github.com/jest-community/vscode-jest/blob/HEAD/setup-wizard.md) to continue. 
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/runmode-tradeoff.png" alt="runmode-tradeoff" width="400" style="border-radius: 10px;"/>
...
<img src="https://github.com/jest-community/vscode-jest/raw/HEAD/images/autoRun-tradeoff.jpg" alt="autoRun-tradeoff" width="600"/>
...
- for test run:
  A solution is introduced in [v5.0.2](https://github.com/jest-community/vscode-jest/blob/HEAD/release-notes/release-note-v5.md#v50-pre-release-roll-up), which will [automatically recover with a login-shell](#auto-recovery-login-shell) during such situation. Hopefully, this should not be an issue any more 🤞.
- for test debugging:
